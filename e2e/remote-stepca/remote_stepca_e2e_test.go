...
// RemoteStepCASuite tests remote Step CA connectivity, provider listing, and session lifecycle.
type RemoteStepCASuite struct {
	suite.Suite
}

func TestRemoteStepCASuite(t *testing.T) {
	suite.Run(t, new(RemoteStepCASuite))
}
...
func (s *RemoteStepCASuite) connectRemote() *bridgeclient.Client {
	t := s.T()
	t.Helper()
...
func (s *RemoteStepCASuite) TestRemoteHealth() {
...
func (s *RemoteStepCASuite) TestRemoteListProviders() {
	client := s.connectRemote()
...
func (s *RemoteStepCASuite) TestRemoteEchoSession() {
	client := s.connectRemote()
...
func (s *RemoteStepCASuite) TestRemoteClaudeSession() {
...
func (s *RemoteStepCASuite) TestRemoteCodexSession() {
